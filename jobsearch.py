...
@dlt.source
def jobsearch_source(api_secret_key: str = dlt.secrets.value):
    # print(f"api_secret_key={api_secret_key}")
    return jobsearch_resource(api_secret_key)
...
if __name__ == "__main__":
    ...
    pipeline = dlt.pipeline(
        ...
        dataset_name='jobsearch_data',
    )

    data = list(jobsearch_resource())
